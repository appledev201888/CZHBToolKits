...
Pod::Spec.new do |s|
  ...
  s.name         = "CZHBToolKits"
  s.version      = "0.0.1"
  s.summary      = "A short description of CZHBToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CZHBToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CZHBToolKits.git", :tag => "#{s.version}" }
